...
public class DialogoVentasVender extends JDialog implements ActionListener, ItemListener {
	...
	public DialogoVentasVender() {
		...
		lblMarca.setBounds(24, 77, 141, 23);
		contentPanel.add(lblMarca);
		
		lblCantidadDeResmas = new JLabel("Cantidad de resmas");
		lblCantidadDeResmas.setForeground(Color.DARK_GRAY);
		lblCantidadDeResmas.setHorizontalAlignment(SwingConstants.LEFT);
		lblCantidadDeResmas.setFont(new Font("Segoe UI", Font.BOLD, 14));
		lblCantidadDeResmas.setBounds(24, 115, 141, 23);
		...
		cboMarca.setBounds(175, 77, 257, 23);
		contentPanel.add(cboMarca);
		
		txtCantidad = new JTextField();
		txtCantidad.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		txtCantidad.setBounds(175, 115, 257, 23);
		contentPanel.add(txtCantidad);
		txtCantidad.setColumns(10);
		txtCantidad.addActionListener(this);
		
		btnVender = new JButton("Vender");
		btnVender.setIcon(new ImageIcon(DialogoVentasVender.class.getResource("/img/btnVender.png")));
		btnVender.setFont(new Font("Segoe UI", Font.BOLD, 14));
		btnVender.addActionListener(this);
		btnVender.setBounds(450, 162, 133, 46);
		contentPanel.add(btnVender);
		
		btnCerrar = new JButton("Cerrar");
		btnCerrar.setIcon(new ImageIcon(DialogoVentasVender.class.getResource("/img/btnCancelar.png")));
		btnCerrar.setFont(new Font("Segoe UI", Font.BOLD, 14));
		btnCerrar.addActionListener(this);
		btnCerrar.setBounds(450, 219, 133, 46);
		contentPanel.add(btnCerrar);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(14, 162, 418, 279);
		...
		lblTitulo = new JLabel("VENDER PAPEL");
		lblTitulo.setHorizontalAlignment(SwingConstants.LEFT);
		lblTitulo.setForeground(Color.DARK_GRAY);
		lblTitulo.setFont(new Font("Tahoma", Font.BOLD, 24));
		lblTitulo.setBounds(24, 23, 228, 29);
		contentPanel.add(lblTitulo);
		
		lblIcono = new JLabel("");
		lblIcono.setIcon(new ImageIcon(DialogoVentasVender.class.getResource("/img/vender.png")));
		lblIcono.setBounds(450, 11, 133, 127);

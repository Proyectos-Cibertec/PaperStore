...
public class DialogoVentasGenerarReportes extends JDialog implements ActionListener, ItemListener {
	...
	public DialogoVentasGenerarReportes() {
		...
		lblNewLabel.setBounds(22, 51, 110, 23);
		contentPanel.add(lblNewLabel);
		
		cboTipoReporte = new JComboBox<String>();
		cboTipoReporte.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		...
		cboTipoReporte.setBounds(142, 51, 480, 23);
		contentPanel.add(cboTipoReporte);
		
		btnCerrar = new JButton("Cerrar");
		btnCerrar.setIcon(new ImageIcon(DialogoVentasGenerarReportes.class.getResource("/img/btnCancelar.png")));
		btnCerrar.setFont(new Font("Segoe UI", Font.BOLD, 14));
		btnCerrar.addActionListener(this);
		btnCerrar.setBounds(498, 475, 124, 46);
		contentPanel.add(btnCerrar);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(22, 85, 600, 379);
		...
		lblTitulo.setBounds(252, 11, 139, 29);
